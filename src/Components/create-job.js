    ...
    <div className="modal-background">
      <div className="modal-container p-4">
        ...
        <form className="apply-form py-3" method="get">
          ...
          <select onChange={(event) => setjobExpreience(event.target.value)} className="inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-1 py-2 mb-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100" aria-expanded="true">
          ...
          <input type="button" onClick={() => addjob()} className="rounded-md button-color text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 px-3 py-2 mr-2 text-white" value="Add Job" />
          <button onClick={closeModal} className="rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 focus:ring-offset-gray-800 px-3 py-2 text-black">Cancel</button>
        </form>
      </div>
    </div>
  )
